    ...
    return (
      <div>
       ...
       {this.state.requisições === "pesquisas" ? <div class="form-group" id="pesquisas">
        ...
        {this.state.requisições === "" ? "" : this.state.requisições === "todasRequisições" ? <div className="d-flex"><div className="col-6"><br /><br />
          <TabelaAproveitamentos /></div><div className="col-6"><br /><br />
            <TabelaCertificacoes /></div> </div> : this.state.requisições === "aproveitamento" ? <div className="col-6"><br /> <br />
